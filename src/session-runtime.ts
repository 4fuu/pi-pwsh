...
export class PwshSessionRuntime {
	...
	constructor(ctx: ExtensionContext, pwshExecutable: string) {
		this.ptys = new PtySessionManager(pwshExecutable, ctx.cwd);
	...
	async start(): Promise<void> { await this.rpc.start(); }
